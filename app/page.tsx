...
import { Clock3, ShieldCheck, UserRound, Gem, Headphones, MessageCircle, MapPinned, Luggage, Palmtree, Search, BadgeAlert, WalletCards, CircleHelp, Star, Menu } from "lucide-react";

export const metadata: Metadata = { title: "Travel Partner | Viajes personalizados sin estrés", description: "Diseño, organización y acompañamiento de viajes 100% personalizados. Cuéntame tu viaje por WhatsApp." };
const WA="https://wa.me/TU_NUMERO?text=Hola%2C%20quiero%20planear%20un%20viaje%20personalizado";
const benefits=[
  [Clock3,"Ahorra tiempo","No pierdas horas buscando, yo lo hago por ti."], [ShieldCheck,"Viaja seguro","Te acompaño antes, durante y después de tu viaje."], [UserRound,"100% personalizado","Cada viaje se diseña según tu estilo y presupuesto."], [Gem,"Experiencias únicas","Acceso a lugares, hoteles y experiencias que marcan."], [Headphones,"Atención cercana","Estoy contigo en cada paso del camino."]
] as const;
...
export default function Home(){return <main>
  <header className="hero" id="inicio"><nav><a className="brand" href="#inicio">TRAVEL<br/>PARTNER<span>TU VIAJE, MI PRIORIDAD</span></a><div className="links"><a href="#inicio">Inicio</a><a href="#sobre-mi">Sobre mí</a><a href="#proceso">Servicios</a><a href="#destinos">Destinos</a><a href="#testimonios">Testimonios</a><a href="#faq">FAQ</a></div><a className="wa small" href={WA}><MessageCircle/>Hablemos por WhatsApp</a><Menu className="menu"/></nav>
  <div className="heroCopy"><p className="eyebrow light">VIAJA SIN ESTRÉS, VIVE EXPERIENCIAS INOLVIDABLES</p><h1>Yo me encargo<br/>de todo, tú solo<br/>disfrutas.</h1><p>Planifico viajes personalizados para que vivas<br/>experiencias únicas, sin perder tiempo ni preocuparte<br/>por los detalles.</p><a className="wa" href={WA}><MessageCircle/>Cuéntame tu viaje</a></div></header>
  ...
  <section className="destinations" id="destinos"><p className="eyebrow">INSPÍRATE</p><h2>Algunos destinos que puedo crear para ti</h2><div className="placeGrid">{places.map(([t,d,img])=><article key={t}><img src={img} alt={t}/><h3>{t}</h3><p>{d}</p></article>)}</div></section>
